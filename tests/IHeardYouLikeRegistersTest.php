...
require_once('src/IHeardYouLikeRegisters.php');

class IHeardYouLikeRegistersTest extends TestCase {
    function testCase1() {
        $o = new IHeardYouLikeRegisters();
        $o->setInstructions(<<<EOF
b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10
EOF
        ...
        $this->assertEquals(array('b',    0), $o->step());
        $this->assertEquals(array('a',    1), $o->step());
        $this->assertEquals(array('c',   10), $o->step());
        $this->assertEquals(array('c',  -10), $o->step());
        $this->assertEquals(1, $o->getLargestValue());
        $this->assertEquals(10, $o->getLargestValueEver());
...
EOF
        ...
        $o->run();
        $this->assertEquals(4416, $o->getLargestValue());
        $this->assertEquals(5199, $o->getLargestValueEver());
    }
}
